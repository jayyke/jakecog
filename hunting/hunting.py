...
class Hunting:
    def __init__(self, bot):
        ...
        self.animals = {'fox': ':fox: **_Ring-ding-ding-ding-dingeringeding!_**', 'deer': ':deer: **_Mewww!_**', 'turkey': ':turkey: **_Gobble!_**', 'jake': ':stuck_out_tongue: **_Brother!_**', 'louise': ':cheese: **_GAYYY!_**'}
        self.in_game = []
        self.paused_games = []
